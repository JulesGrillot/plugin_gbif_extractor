...
| :-- | :--: |
| Plugin name | GBIF Extractor |
| Plugin name slugified | gbif_extractor |
| Plugin name class (used in code) | GbifExtractor |
| Plugin category | Database |
| Plugin description short | This plugin allow to download GBIF data. |
| Plugin description long | Based on an extent, the user can download GBIF data. |
| Plugin tags | GBIF,environnement,data,download |
| Plugin icon | default_icon.png |
| Plugin with processing provider | False |
| Author name | Jules GRILLOT |
| Author organization | Company |
| Author email | jules.grillot@etik.com |
| Minimum QGIS version | 3.28 |
| Maximum QGIS version | 3.99 |
| Git repository URL | r |
...
1. Have a look to the [plugin's metadata.txt file](gbif_extractor/metadata.txt): review it, complete it or fix it if needed (URLs, etc.).
